      ...
      {isOpen && (
        <>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
            ...
            >
              {/* 头部区域 */}
              <div className={`${color} backdrop-blur-md rounded-t-[20px] p-6 relative`}>
                {/* 关闭按钮 */}
                <button
                  onClick={onClose}
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    {subtitle && (
                      <div className="mt-2 flex items-center space-x-3 text-sm text-white/80">
                  ...
                  {endTime && (
                    <div className="space-y-1">
                      ...
                      <div className="text-xl font-mono text-white tracking-wide">{endTime}</div>
                    </div>
                  )}
                </div>
              </div>
              ...
              {/* 内容区域 */}
              <div className="bg-[#1C1C1C] rounded-b-[20px] p-6">
